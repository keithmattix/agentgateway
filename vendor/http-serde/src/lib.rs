...
pub mod option {
    ...
    boilerplate! { scheme, ::http::uri::Scheme, crate::scheme::SchemeVisitor }
    boilerplate! { header_name, ::http::header::HeaderName, crate::header_name::HeaderNameVisitor }
...
pub mod scheme {
    ...
    impl<'de> Visitor<'de> for SchemeVisitor {
        ...
        #[inline]
        fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
            formatter.write_str("a URI scheme (e.g. 'http' or 'https')")
        }
...
pub mod header_name {
    ...
    impl<'de> Visitor<'de> for HeaderNameVisitor {
        ...
        #[inline]
        fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
            formatter.write_str("a HTTP header name")
        }
